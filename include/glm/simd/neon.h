...
namespace glm {
    namespace neon {
        ...
        static inline float32x4_t copy_lane(float32x4_t vdst, int dlane,
                                            float32x4_t vsrc, int slane) {
#if GLM_ARCH & GLM_ARCH_ARMV8_BIT
            switch (dlane) {
            case 0:
                switch (slane) {
        ...
        static inline float32x4_t mul_lane(float32x4_t v, float32x4_t vlane,
                                           int lane) {
#if GLM_ARCH & GLM_ARCH_ARMV8_BIT
            switch (lane) {
            case 0:
        ...
        static inline float32x4_t madd_lane(float32x4_t acc, float32x4_t v,
                                            float32x4_t vlane, int lane) {
#if GLM_ARCH & GLM_ARCH_ARMV8_BIT
