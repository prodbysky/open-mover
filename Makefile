...
SRC = src/Core/ZipLib.cpp src/Core/log.cpp src/Core/shader.cpp src/Utilities/util.cpp src/Shapes/rect.cpp src/Shapes/colored_rect.cpp src/Window/window.cpp \
